...
// use needed classes
require '../../../models/admin/account/AccountUser.php';
// check database connection
$conn = null;
$conn = checkDbConnection();
// make instance of classes
$account = new AccountUser($conn);
...
if (isset($_SERVER['HTTP_AUTHORIZATION'])) {
    ...
    $account->user_aid = $data['user_id'];
    $current_password = $data['current_password'];
    $account->user_password = $encrypt->doPasswordHash($data["new_password"]);
    $account->user_datetime = date("Y-m-d H:i:s");
